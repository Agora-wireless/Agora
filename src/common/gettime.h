...
public:
    ...
    {
        return cycles_to_sec(avg_cycles(), freq_ghz);
    }

    double avg_us(double freq_ghz) const
    {
        return cycles_to_us(avg_cycles(), freq_ghz);
    }

    double avg_ns(double freq_ghz) const
    {
        return cycles_to_ns(avg_cycles(), freq_ghz);
    }
};
