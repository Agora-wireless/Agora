...
public:
    ...
    bool receive_zf_pkt(size_t frame_id, size_t ant_id);
    bool receive_demod_pkt(size_t frame_id, size_t symbol_id_ul, size_t ant_id);

    // Packet prepare functions
    bool prepare_freq_iq_pkt(size_t frame_id, size_t symbol_id_ul, size_t ant_id);
    bool prepare_zf_pkt(size_t frame_id, size_t ant_id);
    bool prepare_demod_pkt(size_t frame_id, size_t symbol_id_ul, size_t ant_id);
