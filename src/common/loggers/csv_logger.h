...
const std::array<std::string, kAllLogs> kCsvName = {
    "log-dlpsnr-ue", "log-evmsnr-ue", "log-berser-ue", "log-matdlcsi-bs",
    "log-matdlzf-bs"};
const std::array<std::string, kAllLogs> kCsvHeader = {
    ...
    "Frame,Symbol,Subcarrier,BS-Ant,UE-Ant,CSI-Real,CSI-Imag",
    "Frame,Symbol,Subcarrier,BS-Ant,UE-Ant,DLZF-Real,DLZF-Imag"};
#endif
...
class CsvLogger {
 public:
  ...
  inline void Write(size_t u1, size_t u2, size_t u3, size_t u4, size_t u5,
                    float f1, float f2) {
    logger_->info("{},{},{},{},{},{},{}", u1, u2, u3, u4, u5, f1, f2);
  }
