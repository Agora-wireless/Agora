 ...
 */
static inline void adapt_bits_for_mod(const uint8_t* bit_seq_in,
 ...
 */
static inline void adapt_bits_from_mod(const uint8_t* vec_in, uint8_t* vec_out,
...
// encoding
static inline size_t ldpc_encoding_input_buf_size(size_t base_graph,
                                                  size_t zc) {
...
// encoding
static inline size_t ldpc_encoding_parity_buf_size(size_t base_graph,
                                                   size_t zc) {
...
static inline size_t ldpc_encoding_encoded_buf_size(size_t base_graph,
                                                    size_t zc) {
  // We add kMaxProcBytes as padding for the encoder's gather function
