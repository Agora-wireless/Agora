/**
 * @file dl_mac_sender.h
 * @brief Declaration file for the simple downlink mac sender class
 */
#ifndef DL_MAC_SENDER_H_
#define DL_MAC_SENDER_H_
...
class DlMacSender {
 public:
   ...
   */
  DlMacSender(Config* cfg, std::string& data_filename, size_t socket_thread_num,
