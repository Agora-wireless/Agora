...
public:
    ...
    void schedule_fft_task(int offset, int frame_count, Consumer const& consumer);
#if !BIGSTATION
    bool schedule_delayed_fft_tasks(int frame_count, int frame_id, Consumer const& consumer);
#endif
