...
TEST(TestDemul, VaryingConfig) {
  ...
  PtrCube<kFrameWnd, kMaxSymbols, kMaxUEs, int8_t> demod_buffers(
      kFrameWnd, cfg->symbol_num_perframe_, cfg->ue_num_,
  ...
  std::printf(
      ...
      "MB\n",
      cfg->ul_data_symbol_num_perframe_ * kFrameWnd * kMaxAntennas *
