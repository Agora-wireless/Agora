...
{
    short* input_buffer
        = static_cast<short*>(Agora_memory::padded_aligned_alloc(Agora_memory::Alignment_t::k64Align, 2 * N * sizeof(short) * 10000));
    float* input_buffer_float
        = static_cast<float*>(Agora_memory::padded_aligned_alloc(Agora_memory::Alignment_t::k64Align, 2 * N * sizeof(float) * 10000));
    float* output_buffer
        = static_cast<float*>(Agora_memory::padded_aligned_alloc(Agora_memory::Alignment_t::k64Align, 2 * N * sizeof(float) * 10000));
...
static double bench_demod(unsigned N, unsigned iterations)
{
    ...
    uint8_t* output_buffer
        = static_cast<uint8_t*>(Agora_memory::padded_aligned_alloc(Agora_memory::Alignment_t::k64Align, 2 * N * sizeof(uint8_t) * 10000));
    ...
    float _Complex* input
        = static_cast<float _Complex*>(Agora_memory::padded_aligned_alloc(Agora_memory::Alignment_t::k64Align, 2048 * sizeof(float _Complex)));
    float _Complex* output
        = static_cast<float _Complex*>(Agora_memory::padded_aligned_alloc(Agora_memory::Alignment_t::k64Align, 2048 * sizeof(float _Complex)));
