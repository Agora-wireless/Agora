...
sleep 1; ./build/chsim --bs_threads 1 --ue_threads 1 --worker_threads 8 --core_offset 42 --bs_conf_file data/bs-sim-tmp.json --ue_conf_file data/ue-sim-tmp.json >> test_chsim_output.txt &
