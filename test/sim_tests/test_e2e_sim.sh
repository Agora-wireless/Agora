...
sleep 1; ./build/chsim --bs_threads 1 --ue_threads 1 --worker_threads 1 --core_offset 12 --conf_file ${input_filepath}/chsim-tmp.json >> ${output_filepath}/test_chsim_output.txt &
