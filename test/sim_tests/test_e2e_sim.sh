...
sleep 1; ./build/chsim --bs_threads 1 --ue_threads 2 --worker_threads 4 --core_offset 24 --conf_file ${input_filepath}/chsim-tmp.json >> ${output_filepath}/test_chsim_output.txt &
