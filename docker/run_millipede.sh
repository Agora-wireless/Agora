...
### This script is for executing a simple Millipede demo from within the docker container. 
### It first generates the simple simulated uplink data, 
### then it runs a simple Millipede server (receiver),
### and finally it runs the Millipede sender process. 
...
echo "Starting the millipede server."
./build/millipede data/tddconfig-sim-ul.json &
sleep 3

echo "Starting the millipede sender client."
