...
The BS and two Iris UEs are configured to be Alice, Bob, and Eve respectively. [See below.](https://github.com/Agora-wireless/Agora/blob/subset-modulation_fftshift/images/bs%2Bue.pdf)
