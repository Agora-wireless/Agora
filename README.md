[![Build Status](https://4489496cb62a.ngrok.io/buildStatus/icon?job=github_public_agora%2Fuplink_downlink_integration)](https://4489496cb62a.ngrok.io/job/github_public_agora/job/uplink_downlink_integration/)
 ...
 * Run Agora with channel simulator and clients
   ...
   * In another terminal, run  `./build/chsim --bs_threads 1 --ue_threads 1 --worker_threads 2 --core_offset 24 --bs_conf_file data/bs-ul-sim.json --ue_conf_file data/ue-ul-sim.json`
