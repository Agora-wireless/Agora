...
bash l_HPCKit_p_2021.4.0.3347.sh -a --silent --eula accept --components intel.oneapi.lin.dpcpp-cpp-compiler-pro --install-dir ${PROJECT_ROOT}/intel/oneapi/
rm l_BaseKit_p_2021.4.0.3422.sh l_HPCKit_p_2021.4.0.3347.sh
# echo "source ~/project/intel/oneapi/setvars.sh" >> ~/.bash_profile
source ${PROJECT_ROOT}/intel/oneapi/setvars.sh
...
export LIBRARY_PATH=${LIBRARY_PATH}:${PROJECT_ROOT}/rdma-core/build/lib
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${LIBRARY_PATH}

# Install DPDK
echocyan "Install DPDK"
# echo "export RTE_SDK=~/project/dpdk-stable-20.11.3" >> ~/.bash_profile
export RTE_SDK=${PROJECT_ROOT}/dpdk-stable-20.11.3
cd ${PROJECT_ROOT}
