...
flags = [
    ...
    '-I' + str(home_dir) + '/Agora/src/agora',
    '-I' + str(home_dir) + '/Agora/src/common',
    '-I' + str(home_dir) + '/Agora/src/mac',
    '-I' + str(home_dir) + '/Agora/src/encoder',
    '-I' + str(home_dir) + '/Agora/src/agora/txrx',
