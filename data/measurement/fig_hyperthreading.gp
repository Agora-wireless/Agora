...
set output 'fig_hyperthreading.pdf'
set style line 1 \
...
plot 'fig_hyperthreading.txt' using 2:xtic(1) title "Without hyperthreading" linecolor rgb c1 lw 1.5, '' using 0:2:2 with labels notitle offset -1.8,1 font 'Times-Roman,20', \
	'fig_hyperthreading.txt' using 3 title "With hyperthreading" linecolor rgb c3 lw 1.5, '' using 0:3:3 with labels notitle offset 1.8,1 font 'Times-Roman,20'