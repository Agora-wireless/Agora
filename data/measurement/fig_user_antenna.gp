...
set output 'fig_user_antenna.pdf'
set style line 1 \
...
set ylabel '# users' font 'Times-Roman,20'
...
plot 'fig_user_antenna.txt' using ($1/1.):($2/1.) title '64 antennas' with linespoint linestyle 1 lw 3 pt 7 lc rgb "#e41a1c", \
	'fig_user_antenna.txt' using ($1/1.):($3>=8?$3/1.:1/0) title '128 antennas' with linespoint linestyle 2 lw 3 pt 5 lc rgb "#377eb8"
