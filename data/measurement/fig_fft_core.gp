...
plot 'fig_fft_core.txt' using 2:xtic(1) title "Hydra" linecolor rgb c1 lw 1.5, '' using 0:2:2 with labels notitle offset -1.8,1 font 'Times-Roman,20', \
	'fig_fft_core.txt' using ($3>=8?$3/1.:1/0) title "Time-IQ" linecolor rgb c3 lw 1.5, '' using 0:($3>=8?$3/1.:1/0):($3>=8?$3/1.:1/0) with labels notitle offset 1.8,1 font 'Times-Roman,20'