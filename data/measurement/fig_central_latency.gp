...
set output 'fig_central_latency.pdf'
set style line 1 \
...
set ylabel 'Average latency (ms)' font 'Times-Roman,25'
...
plot 'fig_central_latency.txt' using 2:xtic(1) title "Subcarrier-parallel" linecolor rgb c1 lw 1.5, \
	'fig_central_latency.txt' using 3 title "User-parallel" linecolor rgb c4 lw 1.5