...
plot 'fig_compare.txt' using 2:xtic(1) title "Agora" linecolor rgb c1 lw 1.5, '' using 0:2:2 with labels notitle offset -3.5,1 font 'Times-Roman,20', \
	'fig_compare.txt' using 3 title "Hydra" linecolor rgb c3 lw 1.5, '' using 0:3:3 with labels notitle offset 3.5,1 font 'Times-Roman,20'