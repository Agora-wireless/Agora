...
def init_gui(comp=None, userNum=1, FFT_len=64,update_interval=1000):
	QT_GUI(comp=comp, userNum=userNum, FFT_len=FFT_len, update_interval=update_interval)
...
if __name__ == '__main__':
	...
	mGUI.win.show()
	Thread(target = comp.startCC).start()
